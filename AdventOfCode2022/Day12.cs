...
public class Day12
{
    public static void Part1(string input)
    {
        ...
        {
            Console.WriteLine(string.Join(" ", row.Select(r => ((char)(r.Height + (int)'a')) + (r.FastestHere > 999 ? "XXX" : r.FastestHere.ToString("000")))));
        }
    }
    ...
    public static string TestInput = @"Sabqponm
abcryxxl
accszExk
acctuvwj
abdefghi";

    public static string Input = @"abaaaaaccccccccccccccccccaaaaaaaaaaaaaccccaaaaaaaccccccccccccccccccccccccccccaaaaaa
