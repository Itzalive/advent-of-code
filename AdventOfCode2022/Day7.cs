...
public class Day7
{
    public static void Part1(string input)
    {
        ...
        Console.WriteLine(directories.Sum(d => d.Size));
    }
    ...
    public static void Part2(string input)
    {
        ...
        Console.WriteLine(topLevelDirectory.FindBestDirectory(targetSize, topLevelDirectory).Size);
    }

    public static string TestInput = @"$ cd /
$ ls
dir a
14848514 b.txt
8504156 c.dat
